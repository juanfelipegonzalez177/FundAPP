  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4 w-full">
      ...
      <div className="flex flex-col gap-1.5">
        ...
        <textarea
          className="flex w-full rounded-lg border border-gray-300 bg-[#F3F4F6] dark:bg-surface dark:text-gray-100 dark:border-border-custom px-3.5 py-2.5 text-sm focus:border-[#2D6A4F] focus:outline-none focus:ring-1 focus:ring-[#2D6A4F] min-h-[80px]"
